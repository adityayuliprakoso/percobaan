...
<html lang="en">
<head>
<title>Puskesmas Kasihan I</title>
</head>
<body>
<div id="wrapper">
	<!-- start header -->
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="<?php echo base_url('assets/landing_page/img/kasihan.png')?>" alt="logo" height="60" width="180"/></a>
                </div>
                <div class="navbar-collapse collapse ">
                  <ul class="nav navbar-nav">
                    <li class="active"><a href="<?php echo base_url('landing_page/index')?>">Home</a></li>
				            <li><a href="<?php echo base_url('landing_page/about_us')?>">About Us</a></li>
				            <li><a href="<?php echo base_url('landing_page/services')?>">Services</a></li>
                    <li><a href="<?php echo base_url('landing_page/portofolio')?>">Portfolio</a></li>
                    <li><a href="<?php echo base_url('landing_page/contact')?>">Contact</a></li>
                  </ul>
                </div>
            </div>
        </div>
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="<?php echo base_url('assets/landing_page/img/halaman.jpg')?>" alt="" />
	     ...
	     <div class="row">
							<div class="col-md-7">
								...
								<div class="block-heading-two">
									<h3><span>About Our Care</span></h3>
								</div>
                    ...
                    <div class="latest-post-wrap pull-left">
                        ...
                        <div class="post-item-wrap pull-left col-sm-6 col-md-12 col-xs-12">
                            <img src="<?php echo base_url('assets/landing_page/img/news-1.jpg') ?>" class="img-responsive post-author-img" alt="">
